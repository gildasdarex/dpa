                    ...
                    <div class="panel-heading">
                      ...
                      <div class="panel-collapse collapse" id="collapseOne">
                        <div class="panel-body">
                                     <filterpane:filterPane domain="GroupementEleveur"
                             associatedProperties="activite.libelle, fonctionnement.libelle"/>
                        </div>
                      </div>
                    </div>
              </div>
