                ...
                <tbody>
                    <g:each in="${list_object?}" var="item">
                      <tr>
                        <td>${item?.nom}</td>
                        <td>${item?.prenom}</td>
                        <td>${formatDate(format:'dd-MM-yyyy',date:item?.birthday)}</td>   
                        <td>${item?.profession}</td>
                        <td>${item?.lieu_de_travail}</td>
                        <td>${item?.annee_de_service}</td>
