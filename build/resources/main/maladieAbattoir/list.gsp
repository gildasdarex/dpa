                    ...
                    <div class="panel-heading">
                      ...
                      <div class="panel-collapse collapse" id="collapseOne">
                        <div class="panel-body">
                                     <filterpane:filterPane domain="MaladieAbattoir"
                             associatedProperties="espece.libelle, maladie.libelle, information.libelle"/>
                        </div>
                      </div>
                    </div>
              </div>
               ...
               <table id="simple-table" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Annee</th>
                        <th>Espece</th>
                        <th>Effectif(Total de l'espece)</th>
                        <th>Maladie</th>
                        <th>Information</th>
                        <th>Effectif(malades)</th>
                        <th></th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <g:each in="${list_object?}" var="item">
                      <tr>
                        ...
                        <td>${item?.annee}</td>
                        <td>${item?.espece}</td>
                        <td>${item?.espece.is_conventionnel == true ? item?.espece.get_effectif_conventionnel(item?.departement,item?.commune,item?.annee): item?.espece.get_effectif_non_conventionnel(item?.departement,item?.commune,item?.annee)}</td>
                        <td>${item?.maladie}</td>
