...
<html lang="en">
	...
	<body class="no-skin">
     <div class="page-header">
            <h1>
                Affichage/Infrastrucure transformation
                    ...
                    <div class="panel-heading">
                      ...
                      <div class="panel-collapse collapse" id="collapseOne">
                        <div class="panel-body">
                                     <filterpane:filterPane domain="InfrastructureElevage"
                             associatedProperties="information.libelle,typeInfrastructureElevage.libelle"/>
                        </div>
                      </div>
                    </div>
              </div>
                ...
                <tbody>
                    <g:each in="${list_object?}" var="item">
                      <tr>
                        ...
                        <td>${item?.typeInfrastructureTransformation}</td>
                        <td>${item?.valeur}</td>
                        <td>
