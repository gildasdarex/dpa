...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
                Masque de saisie/Mercurial des denrees
          ...
          <div class="col-xs-12">
               <g:form name="create_data" action="save" class="form-horizontal" role="form">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <g:textField name="prix"  id="form-field-1" placeholder="prix" class="col-xs-10 col-sm-5"/>
                        </div>
                    </div>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <g:textField name="unite"  id="form-field-1" placeholder="unite" class="col-xs-10 col-sm-5 typeahead scrollable"/>
                        </div>
                    </div>
