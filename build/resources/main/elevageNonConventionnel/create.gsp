...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
                Masque de saisie/Elevage non conventionnel
        ...
        <div class="row">
          <div class="col-xs-12">
               <g:form name="create_data" action="save" class="form-horizontal" role="form">
                   ...
                   <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top" for="duallist"> Race </label>
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="race"
                              ...
                              optionKey ="libelle"
                              class="select2" data-placeholder="espece"  />
															<g:link controller="RaceAnimaux" action="create"  class="add-filter btn btn-link">
																 <i class="fa fa-2x fa-plus-circle"></i>
															</g:link>
                        </div>
                   </div>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <g:textField name="age"  id="form-field-2" placeholder="age" class="col-xs-10 col-sm-5"/>
                        </div>
                    </div>

                   <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top" for="duallist"> Unite d'age </label>

                        <div class="col-sm-9">

                            <g:select name="unite_age"
                              from="${['Jours','Semaines','Mois','Annees']}"
                              class="select2" data-placeholder="age"  />
