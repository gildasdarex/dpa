          ...
          <div class="col-xs-12">
               <g:form name="create_data" action="save" class="form-horizontal" role="form">
                   ...
                   <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top"> Origine </label>
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="origine"
                              ...
                              />
															<g:link controller="Lieu" action="create"  class="add-filter btn btn-link">
                   ...
                   <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top"> Destination </label>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top"> Nature </label>
                   ...
                   <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top"> Produit </label>
                        ...
                        <div class="col-sm-9">
                            <g:select name="produit.id"
                              ...
                              class="select2" data-placeholder="produit"  />
														<g:link controller="ProduitCarneList" action="create"  class="add-filter btn btn-link">
						                   <i class="fa fa-2x fa-plus-circle"></i>
						                </g:link>
                        </div>
                   </div>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <g:textField name="valeur"  id="form-field-1" placeholder="Valeur" class="col-xs-10 col-sm-5"/>
                        </div>
                    </div>
                         ...
                         <div class="col-sm-8">
                             <g:textField name="unite"  id="form-field-1" placeholder="Unite" class="col-xs-10 col-sm-5"/>
                         </div>
                     </div>
