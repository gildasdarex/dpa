...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
                Masque de saisie/Culture attelee
        ...
        <div class="row">
          <div class="col-xs-12">
               <g:form name="create_data" action="save" class="form-horizontal" role="form">
                   ...
                   <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top" for="duallist"> Materiel </label>

                        <div class="col-sm-9">

                            <g:select name="materiel.id"
                              from="${materiels}"
                              optionValue ="libelle"
                              optionKey ="id"
                              class="select2" data-placeholder="materiel"  />
															<g:link controller="MaterielCulture" action="create"  class="add-filter btn btn-link">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <g:textField name="quantite"  id="form-field-1" placeholder="Quantite" class="col-xs-10 col-sm-5"/>
                        </div>
                    </div>
