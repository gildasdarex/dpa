...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
               Masque de saisie/Culture attele
          ...
          <div class="col-xs-12">
               <g:form name="create_data" action="update" class="form-horizontal" role="form" id="${edit_object?.id}">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <g:textField name="quantite"  id="form-field-1" 
                            value="${edit_object?.quantite}"              
                            placeholder="quantite" class="col-xs-10 col-sm-5"/>
                        </div>
                    </div>
