...
<html lang="en">
	...
	<body class="no-skin">
     <div class="page-header">
            <h1>
                Affichage/Transhumance frontaliere
                    ...
                    <div class="panel-heading">
                      ...
                      <div class="panel-collapse collapse" id="collapseOne">
                        <div class="panel-body">
                                     <filterpane:filterPane domain="TranshumanceFrontaliere"
                             associatedProperties="acceuil.libelle, provenance.libelle, destination.libelle, information.libelle"/>
                        </div>
                      </div>
                    </div>
              </div>
