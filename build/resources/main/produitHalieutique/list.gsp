                    ...
                    <div class="panel-heading">
                      ...
                      <div class="panel-collapse collapse" id="collapseOne">
                        <div class="panel-body">
                                     <filterpane:filterPane domain="ProduitHalieutique"
                             associatedProperties="nature.libelle,information.libelle, origine.libelle, destination.libelle"/>
                        </div>
                      </div>
                    </div>
              </div>
