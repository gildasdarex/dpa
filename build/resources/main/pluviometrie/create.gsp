        ...
        <div class="row">
          <div class="col-xs-12">
               <g:form name="create_data" action="save" class="form-horizontal" role="form">
                   ...
                   <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top" for="duallist"> Mois </label>

                        <div class="col-sm-9">

                            <g:select name="mois"
                              from="${mois}"
                              class="select2" data-placeholder="mois"  />
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="information.id"
                              ...
                              class="select2" data-placeholder="information"  />
															<g:link controller="InformationPluviometrie" action="create"  class="add-filter btn btn-link">
