                    ...
                    <div class="panel-heading">
                      ...
                      <div class="panel-collapse collapse" id="collapseOne">
                        <div class="panel-body">
                                     <filterpane:filterPane domain="FicheEleveur"
                            excludeProperties="dateCreated"
                             associatedProperties="espece.libelle, typeEleveur.libelle, typeHabitatEleveur.libelle"/>
                        </div>
                      </div>
                    </div>
              </div>
                ...
                <tbody>
                    <g:each in="${list_object?}" var="item">
                      <tr>
                        ...
                        <td>${item?.sexe}</td>  
                        <td>${item?.espece}</td>
                        <td>${item?.typeEleveur}</td>  
                        <td>${item?.typeHabitatEleveur}</td>
                        <td>
