          ...
          <div class="col-xs-12">
               <g:form name="create_data" action="save" class="form-horizontal" role="form">
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="nature.id"
                              ...
                              class="select2" data-placeholder="nature"  />
															...
															<g:link controller="NatureProduitHalieutique" action="create"  class="add-filter btn btn-link">
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="information.id"
                              ...
                              class="select2" data-placeholder="information"  />
															<g:link controller="InformationProduitHalieutique" action="create"  class="add-filter btn btn-link">
																 <i class="fa fa-2x fa-plus-circle"></i>
															</g:link>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <g:textField name="motif"  id="form-field-1" placeholder="Motif" class="col-xs-10 col-sm-5"/>
                        </div>
                    </div>
