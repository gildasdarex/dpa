...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
                Masque de saisie/Fiche signalitique
          ...
          <div class="col-xs-12">
               <g:form name="connexe" action="save" class="form-horizontal" role="form">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <g:textField name="profession"  id="form-field-1" placeholder="Profession" class="col-xs-10 col-sm-5"/>
                        </div>
                    </div>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <g:textField name="lieu_de_travail"  id="form-field-1" placeholder="Lieu de travail" class="col-xs-10 col-sm-5"/>
                        </div>
                    </div>
