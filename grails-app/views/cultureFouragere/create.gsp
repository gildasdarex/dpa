...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
                Masque de saisie/Culture fourragere
        ...
        <div class="row">
          <div class="col-xs-12">
               <g:form name="create_data" action="save" class="form-horizontal" role="form">
                   ...
                   <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top" for="duallist"> Culture </label>

                        <div class="col-sm-9">

                            <g:select name="culture.id"
                              from="${cultures}"
                              optionValue ="libelle"
                              optionKey ="id"
                              class="select2" data-placeholder="culture"  />
															<g:link controller="CultureFouragereList" action="create"  class="add-filter btn btn-link">
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="information.id"
                              ...
                              class="select2" data-placeholder="information"  />
															<g:link controller="InformationCultureFouragere" action="create"  class="add-filter btn btn-link">
																 <i class="fa fa-2x fa-plus-circle"></i>
															</g:link>
