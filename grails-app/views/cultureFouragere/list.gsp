                    ...
                    <div class="panel-heading">
                      ...
                      <div class="panel-collapse collapse" id="collapseOne">
                        <div class="panel-body">
                                     <filterpane:filterPane domain="CultureFouragere"
                             associatedProperties="information.libelle, culture.libelle"/>
                        </div>
                      </div>
                    </div>
              </div>
                ...
                <tbody>
                    <g:each in="${list_object?}" var="item">
                      <tr>
                        ...
                        <td>${item?.commune}</td>
                        <td>${item?.annee}</td>
                        <td>${item?.culture.libelle}</td>
                        <td>${item?.information.libelle}</td>
                        <td>${item?.valeur}</td>
                        <td>
