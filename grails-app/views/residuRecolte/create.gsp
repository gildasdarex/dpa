...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
                Masque de saisie/Residus recolte
        ...
        <div class="row">
          <div class="col-xs-12">
               <g:form name="create_data" action="save" class="form-horizontal" role="form">
                   ...
                   <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top" for="duallist"> Residu </label>

                        <div class="col-sm-9">

                            <g:select name="residu.id"
                              from="${residus}"
                              optionValue ="libelle"
                              optionKey ="id"
                              class="select2" data-placeholder="residu"  />
															<g:link controller="ResiduRecolteList" action="create"  class="add-filter btn btn-link">
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="information.id"
                              ...
                              class="select2" data-placeholder="information"  />
															<g:link controller="InformationResiduRecolte" action="create"  class="add-filter btn btn-link">
																 <i class="fa fa-2x fa-plus-circle"></i>
															</g:link>
