...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
                Masque de saisie/Maladie elevage
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-9">
													...
													<g:select name="maladie.id"
														...
														<g:link controller="MaladieElevageList" action="create"  class="add-filter btn btn-link">
															 <i class="fa fa-2x fa-plus-circle"></i>
														</g:link>
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="information.id"
                              ...
                              class="select2" data-placeholder="information"  />
															<g:link controller="InformationMaladieElevage" action="create"  class="add-filter btn btn-link">
																 <i class="fa fa-2x fa-plus-circle"></i>
															</g:link>
                        </div>
                   </div>
