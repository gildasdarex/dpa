...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
                Masque de saisie/ Fiche des Eleveurs
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="typeEleveur.id"
                              ...
                              class="select2" data-placeholder="type eleveur"  />
															<g:link controller="TypeEleveur" action="create"  class="add-filter btn btn-link">
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="typeHabitatEleveur.id"
                              ...
                              class="select2" data-placeholder="type habitat"  />
															<g:link controller="TypeHabitatEleveur" action="create"  class="add-filter btn btn-link">
																 <i class="fa fa-2x fa-plus-circle"></i>
															</g:link>
