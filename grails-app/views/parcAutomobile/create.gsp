...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
                Masque de saisie/Parc Automobile
               ...
               <g:form name="create_data" action="save" class="form-horizontal" role="form">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="typeAutomobile.id"
                              from="${types}"
                              optionValue ="libelle"
                              optionKey ="id"
                              class="select2" data-placeholder="type"  />
															<g:link controller="TypeAutomobile" action="create"  class="add-filter btn btn-link">
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="information.id"
                              ...
                              class="select2" data-placeholder="information"  />
															<g:link controller="InformationParcAutomobile" action="create"  class="add-filter btn btn-link">
																 <i class="fa fa-2x fa-plus-circle"></i>
															</g:link>
