...
<html lang="en">
	...
	<body class="no-skin">
        <div class="page-header">
            <h1>
                Masque de saisie/Agent technique
        ...
        <div class="row">
          <div class="col-xs-12">
               <g:form name="create_data" action="save" class="form-horizontal" role="form">
                        ...
                        <div class="col-sm-9">
                            ...
                            <g:select name="information.id"
                              ...
                              class="select2" data-placeholder="information"  />
															<g:link controller="InformationAgentTechnique" action="create"  class="add-filter btn btn-link">
                   ...
                   <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-top" for="duallist"> Statut personnel </label>

                        <div class="col-sm-9">

                            <g:select name="statut.id"
                              from="${list_statut}"
                              optionValue ="libelle"
                              optionKey ="id"
                              class="select2" data-placeholder="statut"  />
															<g:link controller="InformationTypePersonnel" action="create"  class="add-filter btn btn-link">
																 <i class="fa fa-2x fa-plus-circle"></i>
															</g:link>
